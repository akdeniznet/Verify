...
class Dizilla : MainAPI() {
    ...
    override var name = "Dizilla Yeni"
    ...
    override suspend fun getMainPage(page: Int, request: MainPageRequest): HomePageResponse {
        ...
        val raw = if (request.name.contains("Bilim Kurgu Dizileri")) {
            app.post(
                "${mainUrl}/api/bg/findSeries?releaseYearStart=2012&releaseYearEnd=2025&imdbPointMin=6&imdbPointMax=10&categoryIdsComma=&countryIdsComma=&orderType=date_desc&languageId=-1&currentPage=1&currentPageCount=24&queryStr=&categorySlugsComma=&countryCodesComma=",
                referer = "${mainUrl}/",
                headers = mapOf(
            ...
            app.post(
                "${mainUrl}/api/bg/findSeries?releaseYearStart=2024&releaseYearEnd=2024&imdbPointMin=6&imdbPointMax=10&categoryIdsComma=15,9,5,2,12,4,8,24,18,3,17&countryIdsComma=1,17,14&orderType=imdb_desc&languageId=-1&currentPage=1&currentPageCount=24&queryStr=&categorySlugsComma=&countryCodesComma=",
                referer = "${mainUrl}/",
                headers = mapOf(
                    "User-Agent" to "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/125.0.0.0 Safari/537.36",
                    "Accept" to "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8",
    ...
    override suspend fun search(query: String): List<SearchResponse> {
        return try {
            ...
            Log.d("HALIL","contentjson = $contentJson")
           ...
           Log.e("HALIL", "Search error: ${e.message}")
            emptyList()
        }
    }
    ...
    override suspend fun loadLinks(
        ...
        try {
            ...
            if (scriptElement == null) {
                Log.e("HALIL", "__NEXT_DATA__ script bulunamadı")
                return false
            }
        ...
        Log.d("HALIL", "secureDataString = $secureDataString")
        ...
        Log.d("HALIL", "decodedData = $decodedData")
...
//        Log.e("HALIL", "Decryption failed: ${e.message}")
        return null
    }
}